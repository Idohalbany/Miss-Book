...
;(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined'
    ...
    : ((global = global || self),
      factory((global.ReactRouter = {}), global.HistoryLibrary, global.React))
  ...
  function useHref(to) {
    ...
    if (basename !== '/') {
      ...
      joinedPathname =
        pathname === '/' ? basename + (endsWithSlash ? '/' : '') : joinPaths([basename, pathname])
    }
  ...
  function useRoutes(routes, locationArg) {
    ...
    if (locationArg) {
      ...
      let parsedLocationArg =
        typeof locationArg === 'string' ? history.parsePath(locationArg) : locationArg
      !(
        parentPathnameBase === '/' ||

!(function (t, n) {
  ...
  ;(g.createBrowserHistory = function (t) {
    ...
    function a() {
      ...
      return [
        t.idx,
        b({ pathname: n, search: e, hash: r, state: t.usr || null, key: t.key || 'default' }),
      ]
    }
    var i = null
    ...
    function h(t, n) {
      return (
        void 0 === n && (n = null),
        b(
          m({ pathname: e.pathname, hash: '', search: '' }, 'string' == typeof t ? E(t) : t, {
            state: n,
            key: S(),
          })
        )
    ...
    (g.createHashHistory = function (t) {
      ...
      function f(t, n) {
        return (
          void 0 === n && (n = null),
          b(
            m({ pathname: r.pathname, hash: '', search: '' }, 'string' == typeof t ? E(t) : t, {
              state: n,
              key: S(),
            })
          )
    ...
    (g.createMemoryHistory = function (t) {
      ...
      function u(t, n) {
        return (
          void 0 === n && (n = null),
          b(
            m({ pathname: c.pathname, search: '', hash: '' }, 'string' == typeof t ? E(t) : t, {
              state: n,
              key: S(),
            })
          )
